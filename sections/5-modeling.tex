...
为了高效地找到其中的最优化值，我们使用一种类似「模拟退火」的方法进行函数优化。
...
\begin{table}[htbp]
    ...
    \begin{tabular}{ccccccc}
        ...
        & 角速度/$\mathrm{s}^{-1}$ & \N{-0.00610} & \N{0.01502} & \N{0.00135} & \N{0.012130} & \N{0.018767} \\
        & 位移/$\mathrm{m}$ & \N{0.20973} & \N{0.28602} & \N{0.20124} & \N{0.32874} & \N{0.30858} \\
         & 角位移/rad & \N{0.00334} & \N{0.02090} & \N{0.006036183} & \N{0.02598} & \N{0.02289} \\  
        \bottomrule
    \end{tabular}
